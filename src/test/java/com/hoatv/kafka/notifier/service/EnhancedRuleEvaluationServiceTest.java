...
class EnhancedRuleEvaluationServiceTest {

    private EnhancedRuleEvaluationService ruleEvaluationService;
    private ObjectMapper objectMapper;

    @BeforeEach
    void setUp() {
        objectMapper = new ObjectMapper();
        ruleEvaluationService = new EnhancedRuleEvaluationService(objectMapper);
    }
